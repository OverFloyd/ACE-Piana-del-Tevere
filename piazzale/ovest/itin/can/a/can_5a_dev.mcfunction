...
## Set buffer
execute if block 458 52 -118 redstone_block run execute if block 457 52 -118 redstone_block run execute if block 460 53 -118 redstone_block run execute if block 459 53 -118 redstone_block run function pinkusfloydicus:pianadeltevere/piazzale/buffer/set
