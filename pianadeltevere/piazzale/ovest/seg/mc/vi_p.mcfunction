...
## Set buffer
function pinkusfloydicus:pianadeltevere/piazzale/ovest/seg/mc/qc/vi_p
...
# QUADRO CONSENSI
## Check buffer
execute if block 477 52 -118 redstone_block run function pinkusfloydicus:pianadeltevere/piazzale/ovest/seg/mc/vi_p_res
