...
## 10a, 9b, 8, 7
### Set buffer
execute unless block 452 61 -110 red_concrete run execute unless block 456 61 -110 red_concrete run execute unless block 459 61 -110 red_concrete run execute unless block 462 61 -107 red_concrete run function pinkusfloydicus:pianadeltevere/piazzale/buffer/set
