...
# CONTROLLO POSIZIONE (8, 9 R, 10 N)
## Set buffer
execute if block 459 52 -118 redstone_block run execute if block 458 52 -118 redstone_block run execute if block 457 52 -118 redstone_block run function pinkusfloydicus:pianadeltevere/piazzale/buffer/set
