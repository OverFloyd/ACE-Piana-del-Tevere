...
### Segnalazione (console)
#### Check buffer
execute unless block 477 52 -118 redstone_block run execute if block 465 61 -116 red_concrete run say > Dev. 5b già bloccato da un altro itinerario