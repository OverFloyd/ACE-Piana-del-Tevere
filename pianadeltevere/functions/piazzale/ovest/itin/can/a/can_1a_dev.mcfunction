...
## Set buffer
execute if block 462 53 -118 redstone_block if block 457 53 -118 redstone_block if block 458 53 -118 redstone_block if block 461 52 -118 redstone_block run function pianadeltevere:apparato/buffer/set
...
execute unless score @p buffer_10 matches 1 unless block 458 53 -118 redstone_block run say > Dev. 9a richiesto in posizione NORMALE
