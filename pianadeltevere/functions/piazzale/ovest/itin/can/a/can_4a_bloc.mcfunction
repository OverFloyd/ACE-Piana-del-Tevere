...
## 10b, 10a, 9b, 8, 7
### Set buffer
execute if block 450 61 -113 lime_concrete if block 452 61 -110 lime_concrete if block 456 61 -110 lime_concrete if block 459 61 -110 lime_concrete if block 462 61 -107 lime_concrete run function pianadeltevere:apparato/buffer/set
...
#### Check buffer
execute unless score @p buffer_10 matches 1 unless block 450 61 -113 lime_concrete unless block 452 61 -110 lime_concrete run say > Dev. 10a-b già bloccati da un altro itinerario
