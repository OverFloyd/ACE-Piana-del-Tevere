...
function pianadeltevere:piazzale/ovest/dev/aghi/9a_bloc
function pianadeltevere:piazzale/ovest/dev/aghi/9b_bloc
function pianadeltevere:piazzale/ovest/dev/aghi/6b_bloc
...
# QUADRO CONSENSI
setblock 464 53 -133 air
setblock 464 52 -133 redstone_block
...
#function pianadeltevere:piazzale/ovest/seg/can/qc/lib/p