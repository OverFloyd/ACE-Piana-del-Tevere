...
## Set buffer
execute if block 462 52 -118 redstone_block if block 457 53 -118 redstone_block if block 458 53 -118 redstone_block if block 461 52 -118 redstone_block run function pianadeltevere:apparato/buffer/set
...
## Dev 9a (QC / console)
### Check buffer
execute unless score @p buffer_10 matches 1 unless block 461 53 -118 redstone_block run setblock 458 51 -118 polished_andesite
execute unless score @p buffer_10 matches 1 unless block 461 53 -118 redstone_block run say > Dev. 9a richiesto in posizione NORMALE
