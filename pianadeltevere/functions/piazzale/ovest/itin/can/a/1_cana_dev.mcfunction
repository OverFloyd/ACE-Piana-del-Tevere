...
## Set buffer
execute if block 462 53 -118 redstone_block run execute if block 457 53 -118 redstone_block run execute if block 458 52 -118 redstone_block run execute if block 461 52 -118 redstone_block run function pianadeltevere:apparato/buffer/set
