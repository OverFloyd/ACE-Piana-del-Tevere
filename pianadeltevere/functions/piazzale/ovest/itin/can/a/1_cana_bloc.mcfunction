...
## 10a, 9b, 9a, 6b, 6a, 5b
### Set buffer
execute if block 452 61 -110 lime_concrete if block 456 61 -110 lime_concrete if block 458 61 -113 lime_concrete if block 462 61 -113 lime_concrete if block 464 61 -116 lime_concrete if block 465 61 -116 lime_concrete run function pianadeltevere:apparato/buffer/set
...
### Segnalazione (console)
#### Check buffer
execute unless score @p buffer_10 matches 1 unless block 465 61 -116 lime_concrete run say > Dev. 5b già bloccato da un altro itinerario