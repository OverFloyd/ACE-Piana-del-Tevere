...
## Set buffer
execute if block 457 53 -118 redstone_block run execute if block 458 53 -118 redstone_block run execute if block 461 53 -118 redstone_block run function pinkusfloydicus:pianadeltevere/apparato/buffer/set
