...
## Set buffer
execute if block 460 53 -118 redstone_block if block 458 53 -118 redstone_block if block 457 52 -118 redstone_block if block 459 52 -118 redstone_block run function pianadeltevere:apparato/buffer/set
