...
## Set buffer
execute if block 457 53 -118 redstone_block run execute if block 458 53 -118 redstone_block run execute if block 459 52 -118 redstone_block run execute if block 460 53 -118 redstone_block run function pianadeltevere:apparato/buffer/set
...
execute unless score @p buffer_10 matches 1 run execute unless block 458 53 -118 redstone_block run say > Dev. 9b richiesto in posizione NORMALE
...
execute unless score @p buffer_10 matches 1 run execute unless block 457 53 -118 redstone_block run say > Dev. 10a richiesto in posizione NORMALE