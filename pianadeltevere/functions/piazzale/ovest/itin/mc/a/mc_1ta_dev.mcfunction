...
## Set buffer
execute if block 462 52 -118 redstone_block run execute if block 461 53 -118 redstone_block run execute if block 456 53 -118 redstone_block run function pianadeltevere:apparato/buffer/set
