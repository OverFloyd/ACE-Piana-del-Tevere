...
execute if score @p buffer_10 matches 0 run function pianadeltevere:piazzale/ovest/seg/mc/qc/lib/a

# LIBERAZIONE ITINERARIO
execute if score @p buffer_10 matches 0 run function pianadeltevere:apparato/qc/sez/b2/occ/8_lib