...
## Check buffer
execute if score @p buffer_10 matches 1 run function pianadeltevere:piazzale/ovest/seg/can/itin/vi_a
...
# LEOPOLDER
## Check buffer
execute if score @p buffer_10 matches 1 run function pianadeltevere:apparato/leopolder/can_d
