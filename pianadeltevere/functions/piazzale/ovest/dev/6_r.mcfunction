...
# DEVIATOIO INGLESE
## Check buffer
execute if score @p buffer_10 matches 1 run function pianadeltevere:piazzale/ovest/dev/6_r_ing

# MANOVRA
## Check buffer
execute if score @p buffer_10 matches 1 run setblock 464 62 -116 minecraft:redstone_torch
