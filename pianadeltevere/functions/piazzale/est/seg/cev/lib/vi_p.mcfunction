...
execute if score @p buffer_10 matches 0 run function pianadeltevere:piazzale/est/seg/cev/qc/lib/p

# LIBERAZIONE ITINERARIO
execute if score @p buffer_10 matches 0 run function pianadeltevere:apparato/qc/sez/b1/occ/3_lib