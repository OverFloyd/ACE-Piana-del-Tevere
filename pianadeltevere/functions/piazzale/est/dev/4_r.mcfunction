...
# DEVIATOIO INGLESE
execute if score @p buffer_10 matches 1 run function pianadeltevere:piazzale/est/dev/4_r_ing

# MANOVRA
execute if score @p buffer_10 matches 1 run setblock 498 62 -113 minecraft:redstone_torch
