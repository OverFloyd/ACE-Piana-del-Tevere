...
## Set buffer
function pianadeltevere:piazzale/est/itin/gc/d/gc_1d_itin
execute if score @p buffer_10 matches 1 run function pianadeltevere:piazzale/est/seg/gc/check/prot
