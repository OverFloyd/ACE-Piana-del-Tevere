...
### Segnalazione (console)
#### Check buffer
execute unless score @p buffer_10 matches 1 if block 496 61 -116 lime_concrete if block 498 61 -113 lime_concrete run say > Dev. 4b già bloccato da un altro itinerario
