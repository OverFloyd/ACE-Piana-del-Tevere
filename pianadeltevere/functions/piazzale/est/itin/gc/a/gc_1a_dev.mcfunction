...
## Set buffer
execute if block 466 53 -118 redstone_block run execute if block 465 52 -118 redstone_block run execute if block 464 52 -118 redstone_block run function pianadeltevere:apparato/buffer/set
