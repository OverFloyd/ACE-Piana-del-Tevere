...
## Set buffer
execute if block 466 53 -118 redstone_block if block 464 53 -118 redstone_block if block 465 52 -118 redstone_block run function pianadeltevere:apparato/buffer/set
...
### Segnalazione (QC / console)
#### Check buffer
execute unless score @p buffer_10 matches 1 unless block 464 53 -118 redstone_block run setblock 464 51 -118 polished_andesite
execute unless score @p buffer_10 matches 1 unless block 464 53 -118 redstone_block run say > Dev. 11 richiesto in posizione NORMALE