...
## Set buffer
execute if block 468 53 -118 redstone_block run execute if block 467 52 -118 redstone_block run function pinkusfloydicus:pianadeltevere/apparato/buffer/set
...
### Segnalazione (QC / console)
#### Check buffer
execute unless block 477 52 -118 redstone_block run execute unless block 466 53 -118 redstone_block run setblock 467 51 -118 polished_andesite
