...
## 1a, 2a, 2b
### Set buffer
execute unless block 503 61 -107 red_concrete run execute unless block 502 61 -107 red_concrete run execute unless block 500 61 -104 red_concrete run function pinkusfloydicus:pianadeltevere/apparato/buffer/set
