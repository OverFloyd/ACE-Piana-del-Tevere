...
## 4a, 4b, 3a, 3b, 1b
### Sets buffer
execute unless block 496 61 -116 red_concrete run execute unless block 498 61 -113 red_concrete run execute unless block 499 61 -113 red_concrete run execute unless block 501 61 -110 red_concrete run execute unless block 505 61 -110 red_concrete run function pinkusfloydicus:pianadeltevere/apparato/buffer/set
